...
set output '/home/2020.1.08.035/Documentos/analise-de-desempenho/trabalhos/trabalho2/simulacao_ligacao/png/e_n/e[n].png'
...
plot "./csv/e_n/e_n0.95.dat" title 'Ocupação 95% ' \
                   with linespoints ls 3 lw 3 pt 0, \
     "./csv/e_n/e_n0.8.dat" title 'Ocupação 80% ' \
                   with linespoints ls 2 lw 3 pt 0, \
     "./csv/e_n/e_n0.6.dat" title 'Ocupação 60% ' \
